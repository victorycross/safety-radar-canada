...
import { RefreshCw, AlertTriangle, Filter, Globe } from 'lucide-react';
...
const EverbridgeAlertsList: React.FC<EverbridgeAlertsListProps> = ({
  alerts,
  loading,
  error,
  fetchAlerts,
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center text-red-600">
            ...
            Error Loading Everbridge Alerts
          </CardTitle>
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                {filteredAlerts.length} Everbridge alert{filteredAlerts.length !== 1 ? 's' : ''} found
              </CardDescription>
            </div>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Everbridge Alerts</h3>
              <p className="text-gray-600 mb-4">
                {viewFilter === 'all' 
                  ? 'No Everbridge alerts are currently available. Configure the integration to receive alerts.'
                  : `No Everbridge alerts match the current filter: ${viewFilter}`
                }
              </p>
              <Button onClick={fetchAlerts} variant="outline">
                <RefreshCw className="mr-2 h-4 w-4" />
                Refresh Everbridge Alerts
              </Button>
            </div>
          </CardContent>
        </Card>
